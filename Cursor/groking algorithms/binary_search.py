...
# Если границы сомкнулись, то возвращаем None.
    ...
    my_list2 = [x for x in range(100000)]
    print(my_list1)
...
# Бинарный
# поиск выполняется за логарифмическое время.
...
# займет 100 мс. С другой стороны, при бинарном поиске достаточно проверить всего 7 элементов (log2
# 100 равен приблизительно 7), а поиск займет
# 7 мс. 

# Боб проводит бинарный поиск с 1 миллиардом элементов, и на это уходит
# 30 мс (log2
# 1 000 000 000 равен приблизительно 30). 

print("\nПоиск 9999 в списке из 100000 элементов (binary_search.steps.log):")
binary_search.steps.log(my_list2, 9999)
